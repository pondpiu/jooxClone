module.exports = function(app) {
	...
	//api for getting a lyric
	app.get('/musics/lyrics/:mid',function(req,res){
		var mid = req.params.mid;
		Lyric.findOne({'lyric_id' : mid},function(err,lyrics){
			if(err){res.send(err);}
			res.json({
				"message":{
					"header":{
	...
	app.post('/musics/lyrics',function(req,res){
		...
		lyric.lyric_body = req.body.lyric_body;
		lyric.lyric_language = req.body.lyric_language;
		lyric.lyric_version = req.body.lyric_version;
